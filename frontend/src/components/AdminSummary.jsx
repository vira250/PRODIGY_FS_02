...
const AdminSummary= () =>{
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
        ...
        <SummaryCard icon={<FaBuilding />} text="Total Departments" number={5} color="bg-cyan-600"/>
        <SummaryCard icon={<FaMoneyBillWave />} text="Monthly Salary" number="$654" color="bg-cyan-600"/>
      </div>
      <div className="mt-12">
        <h4 className="text-center text-2x1 font-bold">Leave Details</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <SummaryCard icon={<FaFileAlt/>} text="Leave Applied" number={5} color="bg-red-600"/>
