...
import { NavLink } from 'react-router-dom';
import { FaBars, FaTimes, FaTachometerAlt, FaUser, FaBuilding, FaCalendarAlt, FaMoneyBillWave, FaCogs } from 'react-icons/fa';
...
const AdminSidebar = ({ isOpen, setIsOpen }) => {
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-screen w-64 bg-white shadow-lg border-r border-gray-200 z-50
          transform transition-transform duration-300
          ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}
        `}
      >
